    ...
    <div class="row">
      ...
      <?php
        if (isset($_GET['edit'])) {
          $id = $_GET['edit'];
          $update = true;
          $record = mysqli_query($conn, "SELECT * FROM product_type WHERE id=$id");
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        ...
        <a href="/photak-system/pages/product-type.php?create" type="button" class="btn btn-primary<?php if ($create || $update) echo ' d-none'; ?>">
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr id="<?php echo $row["id"]; ?>">
              ...
              <td class="d-flex">
                <a
                  href="/photak-system/pages/product-type.php?edit=<?php echo $row["id"]; ?>"
                  type="button"
                  class="btn btn-sm btn-info edit-btn"
                >
                  <span data-feather="edit-2">
                </a>
                <form method="POST" action="/photak-system/actions/product-type.php">
                  <input type="hidden" name="id" value="<?php echo $row["id"]; ?>">
                  <input type="hidden" name="type" value="delete">
                  <button
                    type="submit"
                    class="btn btn-sm btn-danger"
                    onClick="javascript: return confirm('ยืนยันการลบข้อมูล <?php echo $row["ptype_name"]; ?>');"
                  >
        ...
        <form method="POST" action="/photak-system/actions/product-type.php">
          <div class="form-row">
            <div class="col-md-4 mb-3">
              <label for="ptype_name">ชื่อประเภทครุภัณฑ์คอมพิวเตอร์</label>
              <input type="text" class="form-control" name="ptype_name" required>
            </div>
          </div>
          <input type="hidden" value="create" name="type">
          <a href="/photak-system/pages/product-type.php" class="btn btn-secondary" type="button">ยกเลิก</a>
        ...
        <form method="POST" action="/photak-system/actions/product-type.php">
          <div class="form-row">
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" name="ptype_name" value="<?php echo $ptype_name; ?>" required>
            </div>
          </div>
