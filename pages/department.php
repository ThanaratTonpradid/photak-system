...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteDepartmentDialog"><span data-feather="trash-2"></button>
              </td>
            </tr>
            <tr>
              <td>1,002</td>
      ...
      <!-- Create Form -->
      <div class="create-department-form d-none">
        <h4>เพิ่มแผนก</h4>
        <form>
          <div class="form-row">
            <div class="col-md-4 mb-3">
              <label for="validateName">ชื่อแผนก</label>
      ...
      <!-- Update Form -->
      <div class="edit-department-form d-none">
        <h4>แก้ไขแผนก</h4>
        <form>
          <div class="form-row">
            <div class="col-md-4 mb-3">
      ...
      <!-- Delete Modal -->
      <div class="modal fade" id="deleteDepartmentDialog" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="deleteDepartmentDialogLabel">ยืนยันการลบข้อมูล</h4>
