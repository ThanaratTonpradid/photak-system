  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr id="<?php echo $row["id"]; ?>">
              ...
              <td class="d-flex">
                <a
                  href="/photak-system/pages/assign-repair.php?edit=<?php echo $row["id"]; ?>"
                  type="button"
                ...
                <a
                  href="/photak-system/pages/assign-repair.php?create=<?php echo $row["id"]; ?>"
                  type="button"
                  class="btn btn-sm btn-primary edit-btn<?php echo !$row['em_repair'] ? '' : ' d-none';?>"
                >
                  <span data-feather="check"></span>กำหนดผู้รับผิดชอบ
                </a>
              </td>
            </tr>
            <?php
      ...
      <div class="create-form<?php if (!$create) echo ' d-none'; ?>">
        ...
        <form method="POST" action="/photak-system/actions/assign-repair.php">
          <div class="form-row">
          ...
          <a href="/photak-system/pages/assign-repair.php" class="btn btn-secondary" type="button">ยกเลิก</a>
